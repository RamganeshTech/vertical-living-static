...
const CalculatorFloatingButton = ({ onClick }: { onClick: () => void }) => {
  return (
    <motion.button
      ...
      className="fixed cursor-pointer bottom-[110px] right-7 z-[9998] w-14 h-14 bg-[#ffc000] text-[#1a1a1a] rounded-full shadow-2xl flex items-center justify-center border-4 border-white group"
    >
      <i className="fa fa-calculator text-xl"></i>
