...
export const HOUSE_TYPES_DATA = [
    {
        ...
        shortDescription: 'Maximizing utility without compromising on aesthetics for dynamic urban living.',
        longDescription: 'For urban professionals and nuclear families, a 2 BHK apartment is a canvas for smart, efficient living. In city environments where square footage is at a premium, our approach goes beyond basic aesthetics; we engineer space. We implement intelligent floor-to-ceiling storage solutions, seamless loft integrations, and hidden compartments that keep daily clutter strictly out of sight. Our modular kitchens are specifically designed for rigorous Indian cooking, utilizing Boiling Water Proof (BWP) plywood, premium soft-close mechanisms, and ergonomic work triangles that maximize efficiency. By incorporating strategic lighting, reflective surfaces, and modern minimalist color palettes, we create the optical illusion of wider, breathable spaces. Every element, from floating TV units to dual-purpose study zones, is custom-crafted to ensure fluid movement, ensuring your compact home feels exceptionally open and luxurious.',
        image: img1,
        ...
        features: [
            {
                ...
                description: 'Floor-to-ceiling sliding wardrobes and concealed loft spaces to maximize vertical utility.',
                icon: 'fa-solid fa-box-open'
            },
            {
                title: 'Engineered Kitchens',
                description: 'BWP grade materials with tandem drawers, specifically designed for heavy Indian culinary use.',
                icon: 'fa-solid fa-kitchen-set'
            },
            {
                title: 'Spatial Illusions',
                description: 'Strategic placement of mirrors, fluted glass, and profile lighting to enhance room depth.',
                icon: 'fa-solid fa-expand'
            }
        ],
        // keyHighlights: ['Multi-functional Furniture', 'Minimalist Aesthetics', 'High-Traffic Durability', 'Optimized Work Triangles']

        keyHighlights: [
            { text: 'Space-Saving Furniture', icon: 'fa-solid fa-compress-arrows-alt' },
            { text: 'Modular Kitchen BWP', icon: 'fa-solid fa-kitchen-set' },
            { text: 'Smart Storage Lofts', icon: 'fa-solid fa-boxes-stacked' },
            { text: 'Compact Study Nooks', icon: 'fa-solid fa-laptop-house' }
        ],
        idealFor: [
            { text: 'Young Professionals', icon: 'fa-solid fa-user-tie' },
            { text: 'Fast-Paced Couples', icon: 'fa-solid fa-user-group' },
            { text: 'First-Time Homebuyers', icon: 'fa-solid fa-house-chimney-user' },
            { text: 'Hybrid Remote Workers', icon: 'fa-solid fa-laptop-house' }
        ],
    },
    {
        id: '3bhk',
        ...
        shortDescription: 'Seamlessly blending private sanctuaries with vibrant family entertainment areas.',
        longDescription: 'The 3 BHK is the quintessential family home, requiring a delicate architectural balance between communal gathering areas and private sanctuaries. Our interior architecture focuses on harmonious multi-generational living. We design expansive, welcoming living rooms equipped with acoustically treated entertainment units and ambient cove lighting—perfect for hosting guests. Simultaneously, we carve out dedicated, Vastu-compliant Puja rooms featuring intricate CNC jali work and premium brass accents. The private quarters are highly personalized: master suites feature plush headboards, layered mood lighting, and walk-in style wardrobes, while children’s rooms integrate ergonomic study zones and safe, accessible storage. We prioritize high-durability acrylic, PU, and premium laminate finishes that withstand daily family wear-and-tear while maintaining a pristine, magazine-cover aesthetic.',
        image: img2,
        icon: 'fa-solid fa-bed',
        gridClass: 'md:col-span-2 md:row-span-1 aspect-[16/9]',
        features: [
            {
                title: 'Vastu & Tradition',
                description: 'Dedicated, elegantly designed Puja units with backlit panels and traditional motifs.',
                icon: 'fa-solid fa-om'
            },
            {
                title: 'Master Sanctuaries',
                description: 'Luxury bedroom designs featuring layered lighting, premium veneers, and vanity spaces.',
                icon: 'fa-solid fa-moon'
            },
            {
                title: 'Entertainment Zones',
                description: 'Custom TV units with wire management and acoustic paneling for cinematic experiences.',
                icon: 'fa-solid fa-tv'
            }
        ],
        // keyHighlights: ['Vastu Compliant Layouts', 'Acoustic Paneling', 'Kid-Friendly Zones', 'Premium PU Finishes']
        keyHighlights: [
            { text: 'Vastu Compliant Puja', icon: 'fa-solid fa-om' },
            { text: 'Acoustic TV Units', icon: 'fa-solid fa-volume-high' },
            { text: 'Multi-Gen Layouts', icon: 'fa-solid fa-people-roof' },
            { text: 'Balcony Sit-outs', icon: 'fa-solid fa-chair' }
        ],

        idealFor: [
            { text: 'Growing Families', icon: 'fa-solid fa-children' },
            { text: 'Multi-Generational Living', icon: 'fa-solid fa-people-roof' },
            { text: 'Established Homeowners', icon: 'fa-solid fa-house-circle-check' },
            { text: 'Weekend Hosts', icon: 'fa-solid fa-martini-glass-citrus' }
        ],
    },
    {
        id: '4bhk',
        title: '4 BHK Luxury',
        subtitle: 'Expansive Elegance',
        shortDescription: 'Bespoke designs offering unparalleled comfort, grand aesthetics, and premium finishes.',
        longDescription: 'A 4 BHK residence offers the ultimate canvas for true architectural grandeur and bespoke luxury. We approach these expansive spaces with a focus on opulent materials, sophisticated automation, and statement furniture pieces. Designed for those who appreciate the finer things and love to host, these homes feature impressive foyer entrances, grand dining spaces capable of seating extended family, and ultra-premium modular kitchens often split into "wet" and "dry" zones for hosting efficiency. Master suites are transformed into private retreats complete with extensive walk-in wardrobes and lounge seating. Material selections lean heavily into luxury: Italian marble textures, fluted wooden panels, tinted glass wardrobes, and brushed gold or matte black hardware. Every inch is curated to reflect high-net-worth living.',
        image: img3,
        ...
        features: [
            {
                ...
                description: 'Extensive use of Italian marble textures, natural wood veneers, and brushed metal accents.',
                icon: 'fa-solid fa-sparkles'
            },
            {
                title: 'Walk-in Wardrobes',
                description: 'Boutique-style dressing rooms with glass displays, island storage, and integrated lighting.',
                icon: 'fa-solid fa-shirt'
            },
            {
                title: 'Culinary Excellence',
                description: 'Dual kitchen setups (wet/dry) featuring breakfast counters and built-in premium appliances.',
                icon: 'fa-solid fa-blender'
            }
        ],
        // keyHighlights: ['Wet & Dry Kitchens', 'Boutique Wardrobes', 'Smart Home Integration', 'Italian Marble Aesthetics']
        keyHighlights: [
            { text: 'Wet & Dry Kitchens', icon: 'fa-solid fa-faucet-drip' },
            { text: 'Boutique Wardrobes', icon: 'fa-solid fa-shirt' },
            { text: 'Italian Marble Styles', icon: 'fa-solid fa-gem' },
            { text: 'Grand Entrance Foyer', icon: 'fa-solid fa-door-open' }
        ],

        idealFor: [
            { text: 'Corporate Executives', icon: 'fa-solid fa-briefcase' },
            { text: 'Frequent Large-Scale Hosts', icon: 'fa-solid fa-champagne-glasses' },
            { text: 'Statement Luxury Seekers', icon: 'fa-solid fa-crown' },
            { text: 'Extended Families', icon: 'fa-solid fa-users-rectangle' }
        ],
    },
    {
        id: 'villa',
        ...
        shortDescription: 'End-to-end interior architecture for sprawling spaces, combining luxury with legacy.',
        longDescription: 'Designing a villa requires a comprehensive masterplan that connects multiple levels harmoniously, turning a massive structure into a cohesive, warm home. We specialize in amplifying vertical scale—integrating double-height living rooms accented by massive statement chandeliers, sweeping customized staircases with frameless toughened glass railings, and seamless indoor-outdoor transitions. Villas allow for specialized lifestyle rooms: fully soundproofed home theaters, private bar lounges, home gymnasiums, and landscaped terrace gardens. We utilize end-to-end smart home automation to control lighting, climate, and security across the expansive property. The design language is consistent yet dynamic, ensuring that while the ground floor offers palatial spaces for entertaining, the upper levels provide serene, highly secure private quarters tailored to individual family members.',
        image: img4,
        icon: 'fa-solid fa-house-chimney',
        gridClass: 'md:col-span-1 md:row-span-1 aspect-square',
        features: [
            {
                title: 'Vertical Grandeur',
                description: 'Double-height ceilings, majestic chandeliers, and custom-engineered internal staircases.',
                icon: 'fa-solid fa-stairs'
            },
            {
                title: 'Lifestyle Spaces',
                description: 'Integration of private home theaters, bar lounges, and landscaped indoor courtyards.',
                icon: 'fa-solid fa-film'
            },
            {
                title: 'Seamless Automation',
                description: 'Whole-house smart integration for lighting, climate control, and advanced security.',
                icon: 'fa-solid fa-microchip'
            }
        ],
        // keyHighlights: ['Double-Height Spaces', 'Home Theaters', 'Terrace Integration', 'Custom Chandeliers']
        keyHighlights: [
            { text: 'Double-Height Living', icon: 'fa-solid fa-arrows-up-down' },
            { text: 'Private Home Theater', icon: 'fa-solid fa-film' },
            { text: 'Internal Glass Lift', icon: 'fa-solid fa-elevator' },
            { text: 'Terrace Garden Sync', icon: 'fa-solid fa-leaf' }
        ],
        idealFor: [
            { text: 'High-Net-Worth Individuals', icon: 'fa-solid fa-gem' },
            { text: 'Large Joint Families', icon: 'fa-solid fa-users-line' },
            { text: 'Legacy Estate Builders', icon: 'fa-solid fa-monument' },
            { text: 'Privacy & Exclusivity Seekers', icon: 'fa-solid fa-shield-halved' }
        ],
    }
];